...
impl SampleResourceInfo for SymphoniaDecoder {
    ...
    fn num_channels(&self) -> core::num::NonZeroUsize {
        core::num::NonZeroUsize::new(self.spec.channels.count()).unwrap()
    }

    fn sample_rate(&self) -> Option<core::num::NonZeroU32> {
        Some(core::num::NonZeroU32::new(self.spec.rate).unwrap())
    }
}
...
impl SymphoniaDecoder {
    ...
    fn refine_position(&mut self, seek_res: SeekedTo) -> bevy_ecs::error::Result<()> {
