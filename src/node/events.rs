...
///
/// By default, audio events generated by `bevy_seedling` are not timestamped.
/// That means they'll apply at the beginning of the next audio processing block,
/// rather than at some time within that block or later on.
///
/// If you want to guarantee the scheduling of all events, refer to the
/// [`ScheduleDiffing`] component.
///
